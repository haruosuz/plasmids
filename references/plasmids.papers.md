...
Coevolution of host–plasmid pairs facilitates the emergence of novel multidrug resistance | Nature Ecology & Evolution

https://www.nature.com/articles/s41559-017-0243-2
Compensatory mutations improve general permissiveness to antibiotic resistance plasmids | Nature Ecology & Evolution
...
Li L1, Dechesne A1, Madsen JS2, Nesme J2, Sørensen SJ2, Smets BF3.
...
日本農芸化学会２０１９年度大会 （2019年3月24日） 招待講演以外

http://www.lc.shizuoka.ac.jp/pdf/baio36shintani.pdf
難培養性微生物をも対象にしたプラスミドの宿主域の解明

https://kaken.nii.ac.jp/ja/grant/KAKENHI-PROJECT-15KK0278/
KAKEN — 研究課題をさがす | 複合微生物系におけるプラスミドの「真の」宿主域の解明（国際共同研究強化） (KAKENHI-PROJECT-15KK0278)
また，得られたプラスミドについて，種々の条件における宿主域を比較したところ，酸素濃度の違いや，プラスミド自体の塩基組成の違いによって，その見かけの宿主域が変化することも判明した．

2019/09/10
https://www2.aeplan.co.jp/jsme2019/pdf/koen.pdf
日本微生物生態学会 第33回大会 講演要旨集
- P2-17
複合微生物系で実際に伝播するPromA群プラスミドの取得と解析
- P2-18
同一不和合性群に属するプラスミドであってもその宿主域は異なる
【背景・目的】環境中に広く分布することが予測されている，不和合性群PromAに属する2つのプラスミドpSN1104-11と
pSN0729-62は同一細胞内で共存できない（不和合性）．しかし双方のGC含量が10％異なる（1）．同様にIncP-1群に属する
とされるプラスミドpBP136とpDS1においてもGC含量が18％異なる．プラスミドのGC含量は宿主染色体のGC含量よりも低
く，その違いは10％以内であることが多い（2）．
以上の結果から，同じ不和
合性群に属するにも関わらず，塩基組成の違いによって宿主域が異なり，プラスミドと宿主染色体のGC含量に相関があるこ
とが示唆された，現在は，pBP136とpDS1の宿主域の比較を行っている．同時に，宿主域の違いが塩基組成によるものであ
るかを検証するため，同じPromA群に属し，61％のGC含量をもつpMH0613-68の宿主域の調査を行っている．
...
Münch K1,2, Münch R1,2, Biedendieck R1,2, Jahn D1,2, Müller J3,4.
...
- Mathematical studies of the centralities of these worlds’ subnetworks demonstrate that plasmids, not viruses, were key vectors of genetic exchange between bacterial chromosomes, both recently and in the past.
