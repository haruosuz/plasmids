...
http://mgen.microbiologyresearch.org/content/journal/mgen/10.1099/mgen.0.000164
...
https://www.biorxiv.org/content/early/2018/03/02/250266
...
https://www.biorxiv.org/content/biorxiv/early/2018/03/02/250266.full.pdf

243 the elements (ICE or CP) to a distant bacterial host. We identified the latter element based
244 on the differences in terms of tri-nucleotide composition between the elements and the
245 host chromosomes (defined as pvalue in (31)). We then computed for each ICE-CP pair the

448 Distance to the host
449 We used the differences in tri-nucleotide composition to compute the genetic distance
450 between the mobile element and its host chromosome, as previously proposed (65). The

455 frequency of a given k-mer in the sequence (31). We first computed the Mahalanobis

31. Suzuki H, Yano H, Brown CJ, Top EM (2010) Predicting plasmid promiscuity based on genomic signature. J Bacteriol 192(22):6045–55.

65. Suzuki H, Sota M, Brown CJ, Top EM (2008) Using Mahalanobis distance to compare genomic signatures between bacterial plasmids and chromosomes. Nucleic Acids Res 36(22):e147.
...
DISCUSSION
Potential donors
Numerous viruses and plasmids qualify as potential donors (Tables 1 and ​and5,5, Supplementary Materials 1, 2, 4 and 6). It is not really surprising since they are known as HT vectors. They are often totally or partially inserted together with transferred genes in the host genome (14).
